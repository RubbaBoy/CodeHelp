...
public class StringHTMLTextPainter {
    ...
    public StringHTMLTextPainter(PsiFile psiFile, Project project, String dirName, boolean printLineNumbers) {
        myProject = project;
        myPsiFile = psiFile;
...
//      FileTypeManager.TYPE_JSP.equals(fileType);
        ...
        myHTMLFileName = dirName + File.separator + ExportToStringHTMLManager.getHTMLFileName(psiFile);
    ...
    public String paint(TreeMap refMap, FileType fileType) {
        HighlighterIterator hIterator = myHighlighter.createIterator(myOffset);
        if (hIterator.atEnd()) return "null";
//        StringWriter writer = new StringWriter(new FileOutputStream(myHTMLFileName), CharsetToolkit.UTF8_CHARSET);
...
//        }
    ...
    private int writeReferenceTag(Writer writer, PsiReference ref) throws IOException {
        ...
        fileName.append(ExportToStringHTMLManager.getHTMLFileName(refFile));
